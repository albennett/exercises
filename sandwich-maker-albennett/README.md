Created  a sandwich order form that allows the user to select all the ingredients for a custom deli sandwich. The user has the option to add: 
+ bread
+ meat
+ cheese
+ condiments
...
Prices of ingredient items are stored as JS objects associated with the type of ingredient. 
